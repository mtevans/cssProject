$(document).ready(function(){
  ...
  $(".stars").mouseover(handleMouseOver)
  $(".stars").mouseout(handleMouseOut)
  $(".stars").click(handleStarClick)
  var safari = false;
 ...
 function handleStarClick(e){
   ...
   for(var i = 0; i< stars.length; i++){
     if(i < star.id){
       $(stars[i]).addClass("clicked").addClass("bouncer")
       $(stars[i]).addClass("bouncer")
     } else {
       $(stars[i]).removeClass("clicked")
     }
   }
   setTimeout(function removeBouncer(){
     var stars= $(".stars").children();
     $(stars).removeClass("bouncer")
   }, 400)
 }
